...
while True:
        ...
        request_url = urllib.request.urlopen('http://api.openweathermap.org/data/2.5/weather?q=Vijayawada,IN&appid=d7973a07aeefc9b481436b83ba5eecdd&units=metric')
